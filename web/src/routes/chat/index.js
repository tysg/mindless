...
const Chat = () => {
  ...
  return (
    <div class={style.container}>
      ...
      <div class={style.bubble}><b>{prefix+" "}</b> {speech}</div>
      <div class={style.container}>
        {avatar !== null && (
        ...
        <input class={style.textinput} onInput={(e) => setText(e.target.value)} placeholder="Type a few words..." value={text}></input>
        <button class={style.button} onClick={requestMoreGibberish}>Send ✈️</button>
      </div>
    </div>
  );
};
